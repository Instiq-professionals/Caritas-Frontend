...
const Signup = () => {
  ...
  const validateVolunteerClick1 = () => {
    ...
    if (!isValidEmail(volunteer.email) || volunteer.email == undefined ) {
      setErrorMessage("Ïnvalid email address");
      setProgress(false);
      return;
    }
    if (!isValidPhoneNumber(volunteer.phone_number) || volunteer.email == undefined ) {
      setErrorMessage("Ïnvalid phone number");
      setProgress(false);
      return;
    }
    if (!isValidVolunteer(volunteer.lga) || volunteer.lga == undefined || volunteer.lga.length<3) {
  ...
  const validateVolunteerClick2 = () => {
    if (!isValidVolunteer(volunteer.eduction_level) ||volunteer.eduction_level == undefined || volunteer.eduction_level.length<3) {
    ...
    if (!isValidVolunteer(volunteer.guarantor_first_name)||volunteer.guarantor_first_name == undefined || volunteer.guarantor_first_name.length<3) {
    ...
    if (!isValidPhoneNumber(volunteer.guarantor_phone_number) || volunteer.email == undefined ) {
    ...
    if (!isValidVolunteer(volunteer.guarantor_position) || volunteer.guarantor_position == undefined || volunteer.guarantor_position.length<3) {
      setErrorMessage("Provide a valid guarantor's position");
      setProgress(false);
      return;
    }
    if (!isValidVolunteer(volunteer.guarantor_work_details) || volunteer.guarantor_work_details == undefined || volunteer.guarantor_work_details.length<3) {
  ...
  const handleVolunteerFoodSubmit = (event) => {
    if (event) event.preventDefault();
    if (validateVolunteerClick3()) {
      setErrorMessage("");
      console.log('vffggffgffg')
    }
    // if (page === 6 && selectedType === "Volunteer" && volunteerType=== "Food"){
    //   validateVolunteerClick3();
    //   if (validateVolunteerClick3()){
    //     console.log('in this place'+validateVolunteerClick3())
    //     setErrorMessage("");
    //     setDialogTitle("congrats!!!");
    //     setDialogMessage(
    //     `Congratulations, you have sucessfully signed out, check your email for verifiaction message`
    //   );
    //   setOpenDialog(true);
    //   return;
    //   } 
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <div>
                    ...
                    <Button
                      onClick={() => handleVolunteerFoodFirstPageClick()}
                      variant="contained"
                      color="primary"
                      style={{
                        marginTop: "50px",
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                ...
                <div>
                  ...
                  <Button
                    onClick={() => handleVolunteerFoodSubmit()}
                    variant="contained"
                    color="primary"
                    style={{
                      marginTop: "50px",
