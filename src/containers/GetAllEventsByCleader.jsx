...
const GetAllEventsByCleader = (props) => {
  ...
  const handleViewMyEvent = (id) => {
    props.history.push(`/dashboard/getEventsByCleader/${id}`)
  }
...
const mapStateToProps = state => {
  return {
    loading : state.makeDecisionOnEventByCleader.loading,
    data: state.makeDecisionOnEventByCleader.events?state.makeDecisionOnEventByCleader.events.data:[],
    error: state.makeDecisionOnEventByCleader.error,
  }
};
...
export default connect(mapStateToProps, mapDispatchToProps)(GetAllEventsByCleader);
